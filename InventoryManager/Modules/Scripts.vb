...
Module Scripts
    Public connectionString As String = "Server=INVSUXS-D\INVENTORYSQL;Database=master;Trusted_Connection=True;"
    'Public connectionString As String = "Data Source=192.168.31.245,1433;Network Library=DBMSSOCN;Initial Catalog=master;Trusted_Connection=True;"

    Private machineLogFilePath As String = "C:\Users\inventory\Desktop\Logs\Activity Logs\" + DateTime.Now.ToString("MM-dd-yyy") + ".txt"
    Private errorLogFilePath As String = "C:\Users\Inventory\Desktop\Logs\Error Logs\" + DateTime.Now.ToString("MM-dd-yyy") + "_" + DateTime.Now.ToString("HH-mm") + ".txt"
    Private transactionLogFilePath As String = "C:\Users\Inventory\Desktop\Logs\Transaction Logs\" + DateTime.Now.ToString("MM-dd-yyy") + ".txt"
    ...
    Public Sub LogError(ByVal errorMessage As String, ByVal form As String, ByVal tech As String)
        ...
        Dim oops As String = "UwU We made a oopsie woopsie!! A wittle uh oh boiingo!! The code monkeys at my desk are working VEWY HAWD to fix this!"
        Dim oops2 As String
        oops2 = "⊂_ヽ" + vbNewLine +
                "　 ＼＼ Λ＿Λ" + vbNewLine +
                "　　 ＼(　ˇωˇ)　" + vbNewLine +
