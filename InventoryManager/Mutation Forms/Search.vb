...
Public Class Search
    ...
    Private Sub lstMachines_SelectedValueChanged(sender As Object, e As EventArgs) Handles lstMachines.SelectedValueChanged
        ...
        If lstMachines.SelectedIndex <> -1 Then
            ...
            myCmd.CommandText = "SELECT m.machine_name, m.asset_tag, m.serial_number, c.category_name, d.model_name, m.SIM, m.IMEI, t.center_number, m.employee_username, m.machine_id, m.received_date, m.acquisition_date, k.condition_name, m.machine_center_number " +
                        ...
                        Select Case i
                            ...
                            Case 13
                                If myReader.IsDBNull(i) Then
                                    costCenter = "null"
                                Else
                                    costCenter = myReader.GetInt32(i).ToString
                                End If
                        End Select
                    Next
                Loop
